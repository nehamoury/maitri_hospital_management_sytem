    ...
    <Section bg="ivory" className="relative overflow-hidden">
      <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
        ...
        >
          ...
          {/* Decorative backdrop */}
          <div className="absolute -left-6 -bottom-6 w-full h-full rounded-[40px] border-2 border-[#0F766E]/20 z-0 transition-transform duration-500 group-hover:translate-x-2 group-hover:translate-y-2" />
        </motion.div>
        ...
        >
          ...
          <h2 className="text-4xl lg:text-5xl font-bold text-[#0F172A] mb-6 leading-[1.15]" style={{ fontFamily: "'Poppins', sans-serif" }}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-12">
            {[
              ...
              <div key={i} className="flex items-start gap-3">
                <div className="mt-1 flex-shrink-0 text-[#0F766E]">
          ...
          <Link 
            to="/appointment" 
            className="inline-flex items-center justify-center rounded-full bg-[#0F766E] px-8 py-4 text-sm font-semibold text-white shadow-lg shadow-[#0F766E]/20 hover:bg-[#14B8A6] hover:-translate-y-1 hover:shadow-xl transition-all duration-300"
          >
            Explore Panchakarma
          </Link>
        </motion.div>
