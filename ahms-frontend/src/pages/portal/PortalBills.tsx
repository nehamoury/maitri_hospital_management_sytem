...
import { Calendar, Receipt, ShieldAlert, CreditCard } from 'lucide-react'
      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-emerald-800 to-teal-700 p-6 text-white shadow-lg mb-6">
        ...
        <div className="relative flex items-center justify-between">
          <div className="space-y-1">
            ...
            <h1 className="text-xl md:text-2xl font-extrabold tracking-tight">My Invoices</h1>
            <p className="text-emerald-100/70 text-xs md:text-sm">Track and manage your billing history and payments</p>
          </div>
